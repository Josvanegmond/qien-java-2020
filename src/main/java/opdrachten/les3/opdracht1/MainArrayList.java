package opdrachten.les3.opdracht1;
...
//        taskList.add(new Task("Groceries", DaysOfWeek.MONDAY));

//        TODO: Create the method addTask(...)
//          - the method must create a new Task object and add it to the taskList
//          - uncomment the following line to test the method
//        addTask("Groceries", DaysOfWeek.TUESDAY);

//        TODO: create a loop that waits for user input each time using Scanner
//          - if the user types "exit", close the app
//          - if the user types "new", ask the user for taskinfo and store a new Task for FRIDAY
//          - if the user types "show", use printTasks to show all tasks for FRIDAY
